---
title: "Everything static: Prerendering your Angular App with Scully and host it on GitHub"
description: "With this blog post we will show you how to create static websites with the generator Scully. We will also automatically deploy our site to GitHub Pages."
author: Johannes Hoppe
mail: johannes.hoppe@haushoppe-its.de
bio: "Johannes is one author of the German Angular book and head of the Angular Meetup in Heidelberg, Germany. Furthermore, he founded the Angular.Schule together with Ferdinand Malcher. In his spare time he is engaged in a couple of open source projects."
author2: Danny Koppenhagen
mail2: mail@d-koppenhagen.de
bio2: "Danny works as a software developer for DB Systel GmbH in Germany. He is one author of the German Angular book and a passionate collaborator on some of open source projects, including Scully."
...
keywords:
  ...
  - JAMStack
language: en
thumbnail: scully-logo.png
---

**In this article we want to create powerful pre-rendered Angular Apps with Sully.
It's a new way of creating websites based on Angular that offers better performance, smaller download sizes and higher security. You can see this article as a follow-up to the article ["Everything GitHub: Continues Integration, Deployment and Hosting for your Angular App"](https://angular.schule/blog/2020-01-everything-github), but it is also no problem if you start directly with this article.**
...
> **ℹ️ Note:**
> 
> Sully is currently still in a very early alpha stage.
> Some things will certainly improve or be changed. We try to keep this article up-to-date. If you have found a bug, we would be happy about your help!

## About Scully

Scully is a static site generator (SSG) for Angular apps.
It is one of a group of tools that are described by the term [Jamstack](https://jamstack.org/).

It detects all the routes of an app and will then call every route it found, visit the page in the browser, renders the page and finally put the static rendered page to the file system.
This process is also known as **pre-rendering**.
The result is a compiled and pre-rendered app that is ready to be shipped to our web server.
Das besondere daran ist auch die Tatsache, dass wir auch Datenquellen anbinden können, die im Internet nicht verfügbar sind (z.B. ein Internes Wordpress) oder nur sehr langsam sind. Wir erzeugen einen Schnappsschuss von unseren Daten und die eigentlihe Datenquelle muss dann nicht mehr verfügbar sein.
...
<small>**Header image:** [Scully logo suggestion by Nicolás Avila](https://github.com/scullyio/scully/issues/1#issue-537296693). This is not (yet) the official logo of Scully.</small>